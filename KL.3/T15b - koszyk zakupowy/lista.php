...
<form action="lista.php" method="post">
    ...
    <p>
        <select name="lista[]" multiple="multiple" size="9">
            ...
            <option value="Komputer"> Stacja ładująca</option>
            <option value="Komputer"> Mikrofon</option>
            <option value="Komputer"> Ramie mikrofonowe</option>
            <option value="Komputer"> Podkładka</option>
        </select></p>
